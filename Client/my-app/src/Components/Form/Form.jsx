    ...
    <div className="form-container">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div >
          ...
          <p className="form-groupform ">മേൽ പറഞ്ഞിരിക്കുന്ന കാര്യങ്ങൾ എന്റെ / ഞങ്ങളുടെ <br/>അറിവിലും വിശ്വാസത്തിലും സത്യമാണെന്നും ശ്രീശുദ്ധി <br/>ക്ഷേത്രോദ്ധാരണപദ്ധതിയുടെ നിബന്ധനകൾക്കുവിധേയമായിപ്രവർത്തിച്ചുകൊള്ളാമെന്നും <br/>ഇതിനാൽ ഉറപ്പുനൽകുന്നു.</p>
        </div>
