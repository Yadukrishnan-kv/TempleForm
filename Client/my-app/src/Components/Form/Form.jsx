...
function Form() {
  ...
  const requiredStar = () => <span style={{ color: "red", marginLeft: "3px" }}>*</span>
          ...
          {currentStep === 1 && (
            <div className="step-content">
              ...
              <div>
                ...
                <select className="form-select" name="Nation" value={formData.Nation} onChange={handleChange} required>
          ...
          {currentStep === 2 && (
            <div className="step-content">
              ...
              <div>
                ...
                <select className="form-select" name="address" value={localities} onChange={handlelocalities} required>
              ...
              <div>
                ...
                <div className="regform-file-input">
                  ...
                  {selectedFiles.length > 0 && (
                    <div className="selected-files-info">{selectedFiles.length} file(s) selected</div>
                  )}
                </div>
              </div>
            </div>
