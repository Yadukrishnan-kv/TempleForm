...
function Form() {
  ...
  const [formData, setFormData] = useState({
    ...
    password: "",
    role: "2",
    website: "", // This field is now optional
    templeType: "",
    locationSketch: "",
    history: "",
    mainDeity: "",
    ...
    <div>
      <div className="form-container">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            <label className="form-label">
              Temple Address <span className="malayalam-text">(ക്ഷേത്രത്തിന്റെ മേൽവിലാസം)</span>
            </label>
            <textarea
          ...
          <div>
            ...
            <p className="form-groupform">
              ...
              belief, and I/we agree to abide by the rules and regulations of the Sree Suddhi Temple Renovation Project.
              <br />
              <br />
          ...
          <div className="border-t pt-4 mt-4">
            ...
            <div>
              ...
              <textarea
                className="form-textarea"
                rows={3}
                placeholder="The applicant has been approved/rejected for membership in the Sree Suddhi Temple Renovation Project as per the decision of the governing body dated ........................"
