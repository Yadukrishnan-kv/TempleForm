      ...
      <div className="authentication-wrap overflow-hidden position-relative text-center text-sm-start my-5">
        ...
        <form className="register-form">
          ...
          <div className="form-check mb-4 text-start">
            ...
            <label className="form-check-label" htmlFor="flexCheckDefault">Remember me next time</label>
          </div>
          {/* /.End Checkbox */}
          {/* Start Button */}
        ...
        {/* Start Bottom Text */}
        <div className="bottom-text text-center mt-4"> Don't have an account?  <Link to={'/signup'}  className="fw-medium text-decoration-underline text-dark">Sign Up</Link>
          <br /> Remind <Link to={'/ForgotPassword'}  className="fw-medium text-decoration-underline text-dark">Password</Link>
        </div>
        {/* /.End Bottom Text */}
      </div>
    </div>
