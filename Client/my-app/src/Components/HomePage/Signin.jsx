            ...
            <div className="authentication-wrap overflow-hidden position-relative text-center text-sm-start my-5">
              ...
              <form className="register-form" onSubmit={handleSubmit}>
                ...
                <div className="form-check mb-4 text-start">
                  ...
                  <label className="form-check-label" htmlFor="rememberMe">Remember me next time</label>
                </div>
                {/* /.End Checkbox */}
                {/* Start Button */}
              ...
              <div className="bottom-text text-center mt-4">
                Don't have an account? <Link to="/signup" className="fw-medium text-decoration-underline text-dark">Sign Up</Link>
                <br />
                <Link to="/forgot-password" className="fw-medium text-decoration-underline text-dark">Forgot Password?</Link>
              </div>
              {/* /.End Bottom Text */}
            </div>
          </div>
