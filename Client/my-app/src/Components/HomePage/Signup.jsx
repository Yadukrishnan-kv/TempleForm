...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Remove the extra dot from the URL
      const response = await axios.post(`${ip}/api/UserRoutes/registerUser`, {
            ...
            <div className="authentication-wrap overflow-hidden position-relative text-center text-sm-start my-5">
              <div className="mb-5">
                <h2 className="display-6 fw-semibold mb-3">
                  Welcome back! Please <span className="font-caveat text-primary">Sign up</span> to continue.
                </h2>
                <p className="mb-0">
